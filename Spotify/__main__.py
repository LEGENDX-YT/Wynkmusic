...
async def init():
    ...
    LOGGER("Spotify").info("Music Bot Started Successfully, Now Gib your girlfriend chumt to @Spotify_Owner")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("Spotify").info("Stopping Music Bot, Bhakk Bhosdike (Gaand Maraa Tu)")
